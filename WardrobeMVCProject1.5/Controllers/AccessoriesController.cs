...
namespace WardrobeMVCProject1._5.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Occassion = new SelectList(db.Occasions, "OccasionID", "OccasionName");
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Photo,Name,Type,Price,ItemNumber,Purchase,ColorID,SeasonID,Occassion")] Accessory accessory)
        {
            ...
            ViewBag.Occassion = new SelectList(db.Occasions, "OccasionID", "OccasionName", accessory.Occassion);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Photo,Name,Type,Price,ItemNumber,Purchase,ColorID,SeasonID,Occassion")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
