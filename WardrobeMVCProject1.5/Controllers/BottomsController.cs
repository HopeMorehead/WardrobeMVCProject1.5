...
namespace WardrobeMVCProject1._5.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.OccassionID = new SelectList(db.Occasions, "OccasionID", "OccasionName");
        ...
        public ActionResult Create([Bind(Include = "BottomID,Photo,Name,Type,Price,ItemNumber,Purchase,ColorID,SeasonID,OccassionID")] Bottom bottom)
        {
            ...
            ViewBag.OccassionID = new SelectList(db.Occasions, "OccasionID", "OccasionName", bottom.OccassionID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Photo,Name,Type,Price,ItemNumber,Purchase,ColorID,SeasonID,OccassionID")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
