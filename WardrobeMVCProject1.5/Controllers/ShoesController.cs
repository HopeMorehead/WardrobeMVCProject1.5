...
namespace WardrobeMVCProject1._5.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,Photo,Name,Type,Price,ItemNumber,Purchase,ColorID,SeasonID,OccassionID")] Sho sho)
        {
            ...
            ViewBag.OccassionID = new SelectList(db.Occasions, "OccasionID", "OccasionName", sho.OccassionID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,Photo,Name,Type,Price,ItemNumber,Purchase,ColorID,SeasonID,OccassionID")] Sho sho)
        {
            if (ModelState.IsValid)
            {
