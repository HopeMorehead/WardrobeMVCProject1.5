...
namespace WardrobeMVCProject1._5.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Photo,Name,Type,Price,ItemNumber,Purchase,ColorID,SeasonID,OccassionID")] Top top)
        {
            ...
            ViewBag.OccassionID = new SelectList(db.Occasions, "OccasionID", "OccasionName", top.OccassionID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Photo,Name,Type,Price,ItemNumber,Purchase,ColorID,SeasonID,OccassionID")] Top top)
        {
            if (ModelState.IsValid)
            {
